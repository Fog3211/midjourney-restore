function w(): void {
  const a = document.querySelector<SVGElement>('#bannerSVGLogo') as HTMLOrSVGElement;
  let c: string[] = [];
  let d: SVGTextElement[] = [];
  ...
  let s = v((a.viewBox.baseVal.width - 10) / 1);
  let f = 0;
  let p = 0;
